...
proc checkRequiredFiles { origin_dir} {
  ...
  set files [list \
    ...
    "[file normalize "$origin_dir/xdc/mts.xdc"]"\
    ]
  foreach ifile $files {
...
proc create_hier_cell_hier_dac_play { parentCell nameHier } {
  ...
  if { [catch {set DACRAMstreamer_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.MEM_SIZE_BYTES {131072} $DACRAMstreamer_0
  ...
  set_property CONFIG.IS_ACLK_ASYNC {1} $axis_clock_converter_0
  ...
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins DACRAMstreamer_0/numSampleVectors]
...
proc create_hier_cell_hier_dac_cap { parentCell nameHier } {
  ...
  if { [catch {set ADCRAMcapture_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
    ...
    set_property CONFIG.MEM_SIZE_BYTES {131072} $ADCRAMcapture_0
  ...
  # Create port connections
  connect_bd_net -net Net [get_bd_pins s_axi_aresetn] [get_bd_pins ADCRAMcapture_0/axis_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
...
proc create_hier_cell_hier_adc2_cap { parentCell nameHier } {
  ...
  connect_bd_net -net s_axi_aresetn_1 [get_bd_pins s_axi_aresetn] [get_bd_pins ADCRAMcapture_0/axis_aresetn] [get_bd_pins axi_bram_ctrl_0/s_axi_aresetn] [get_bd_pins axis_clock_converter_0/s_axis_aresetn] [get_bd_pins axis_clock_converter_0/m_axis_aresetn] [get_bd_pins axis_dwidth_converter_0/aresetn]
  connect_bd_net -net trig_cap_1 [get_bd_pins trig_cap] [get_bd_pins ADCRAMcapture_0/trig_cap]
...
proc create_hier_cell_gpio_control { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axi_gpio_0_gpio_io_o [get_bd_pins axi_gpio_fifoflush/gpio_io_o] [get_bd_pins fifoflush]
  connect_bd_net -net axi_gpio_bram_adc_gpio_io_o [get_bd_pins axi_gpio_bram_adc/gpio_io_o] [get_bd_pins xpm_cdc_gen_0/src_in]
  connect_bd_net -net axi_gpio_dac_gpio_io_o [get_bd_pins axi_gpio_dac/gpio_io_o] [get_bd_pins dac_enable]
  ...
  connect_bd_net -net xpm_cdc_gen_0_dest_out [get_bd_pins xpm_cdc_gen_0/dest_out] [get_bd_pins dest_out]
...
proc create_hier_cell_deepCapture { parentCell nameHier } {
  ...
  # Create port connections
  connect_bd_net -net axi_dma_adc_s2mm_introut [get_bd_pins axi_dma_adc/s2mm_introut] [get_bd_pins s2mm_introut]
  connect_bd_net -net axi_resetn_1 [get_bd_pins axi_resetn] [get_bd_pins axi_dma_adc/axi_resetn]
  connect_bd_net -net axis_dwidth_converter_0_m_axis_tdata [get_bd_pins axis_dwidth_converter_0/m_axis_tdata] [get_bd_pins axis_data_fifo_adc/s_axis_tdata]
  connect_bd_net -net axis_dwidth_converter_0_m_axis_tvalid [get_bd_pins axis_dwidth_converter_0/m_axis_tvalid] [get_bd_pins axis_data_fifo_adc/s_axis_tvalid]
  ...
  connect_bd_net -net rst_ddr4_0_333M_peripheral_aresetn [get_bd_pins rst_ddr4_0_333M/peripheral_aresetn] [get_bd_pins peripheral_aresetn]
  connect_bd_net -net s_axis_aresetn_0_1 [get_bd_pins fifo_flush_n] [get_bd_pins axis_data_fifo_adc/s_axis_aresetn]
  connect_bd_net -net xlconstant_0_dout [get_bd_pins xlconstant_0/dout] [get_bd_pins axi_dma_adc/s_axis_s2mm_tlast]
  connect_bd_net -net xlconstant_1_dout [get_bd_pins xlconstant_1/dout] [get_bd_pins axis_dwidth_converter_0/aresetn] [get_bd_pins axis_dwidth_converter_0/m_axis_tready]
...
proc create_hier_cell_clocktreeMTS { parentCell nameHier } {
  ...
  set_property CONFIG.C_BUF_TYPE {IBUFDS} $IBUFDS_PL_CLK
  ...
  set_property CONFIG.C_BUF_TYPE {IBUFDS} $IBUFDS_SYSREF
  ...
  connect_bd_net -net synchronizeSYSREF_dest_out [get_bd_pins synchronizeSYSREF/dest_out] [get_bd_pins UserSYSREF]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins s_axi_aclk] [get_bd_pins MTSclkwiz/s_axi_aclk] [get_bd_pins MTSclkwiz/ref_clk] [get_bd_pins PSreset_control/slowest_sync_clk]
...
\
  ...
  connect_bd_intf_net -intf_net adc2_clk_0_1 [get_bd_intf_ports adc2_clk_0] [get_bd_intf_pins usp_rf_data_converter_1/adc2_clk]
  ...
  connect_bd_intf_net -intf_net dac2_clk_1 [get_bd_intf_ports dac2_clk] [get_bd_intf_pins usp_rf_data_converter_1/dac2_clk]
  ...
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout00 [get_bd_intf_ports vout00_0] [get_bd_intf_pins usp_rf_data_converter_1/vout00]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout02 [get_bd_intf_ports vout02_0] [get_bd_intf_pins usp_rf_data_converter_1/vout02]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout10 [get_bd_intf_ports vout10_0] [get_bd_intf_pins usp_rf_data_converter_1/vout10]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout13 [get_bd_intf_ports vout12_1] [get_bd_intf_pins usp_rf_data_converter_1/vout12]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout21 [get_bd_intf_ports vout20] [get_bd_intf_pins usp_rf_data_converter_1/vout20]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout22 [get_bd_intf_ports vout22_0] [get_bd_intf_pins usp_rf_data_converter_1/vout22]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout30 [get_bd_intf_ports vout30_0] [get_bd_intf_pins usp_rf_data_converter_1/vout30]
  connect_bd_intf_net -intf_net usp_rf_data_converter_1_vout32 [get_bd_intf_ports vout32_0] [get_bd_intf_pins usp_rf_data_converter_1/vout32]
  connect_bd_intf_net -intf_net vin00_1 [get_bd_intf_ports vin00] [get_bd_intf_pins usp_rf_data_converter_1/vin00]
  connect_bd_intf_net -intf_net vin02_1 [get_bd_intf_ports vin02] [get_bd_intf_pins usp_rf_data_converter_1/vin02]
  connect_bd_intf_net -intf_net vin10_1 [get_bd_intf_ports vin10] [get_bd_intf_pins usp_rf_data_converter_1/vin10]
  connect_bd_intf_net -intf_net vin12_1 [get_bd_intf_ports vin12] [get_bd_intf_pins usp_rf_data_converter_1/vin12]
  connect_bd_intf_net -intf_net vin20_0_1 [get_bd_intf_ports vin20_0] [get_bd_intf_pins usp_rf_data_converter_1/vin20]
  connect_bd_intf_net -intf_net vin22_0_1 [get_bd_intf_ports vin22_0] [get_bd_intf_pins usp_rf_data_converter_1/vin22]
  connect_bd_intf_net -intf_net vin30_0_1 [get_bd_intf_ports vin30_0] [get_bd_intf_pins usp_rf_data_converter_1/vin30]
  connect_bd_intf_net -intf_net vin32_0_1 [get_bd_intf_ports vin32_0] [get_bd_intf_pins usp_rf_data_converter_1/vin32]
  ...
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins clocktreeMTS/clkRF] [get_bd_pins deepCapture/s_axis_aclk] [get_bd_pins hier_adc0_cap/aclk] [get_bd_pins hier_adc1_cap/aclk] [get_bd_pins hier_adc2_cap/aclk] [get_bd_pins hier_dac_cap/aclk] [get_bd_pins hier_dac_play/aclk] [get_bd_pins axis_broadcaster_0/aclk] [get_bd_pins usp_rf_data_converter_1/m0_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m1_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s0_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s1_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s2_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m2_axis_aclk] [get_bd_pins usp_rf_data_converter_1/m3_axis_aclk] [get_bd_pins usp_rf_data_converter_1/s3_axis_aclk]
  connect_bd_net -net clk_wiz_adc0_clk_out2 [get_bd_pins clocktreeMTS/clkRFdiv2] [get_bd_pins gpio_control/dest_clk] [get_bd_pins hier_adc0_cap/axis_clk] [get_bd_pins hier_adc1_cap/axis_clk] [get_bd_pins hier_adc2_cap/axis_clk] [get_bd_pins hier_dac_cap/axis_clk] [get_bd_pins hier_dac_play/axis_clk] [get_bd_pins internalRAM_interconnect/ACLK] [get_bd_pins internalRAM_interconnect/S00_ACLK] [get_bd_pins internalRAM_interconnect/M00_ACLK] [get_bd_pins internalRAM_interconnect/M01_ACLK] [get_bd_pins internalRAM_interconnect/M02_ACLK] [get_bd_pins internalRAM_interconnect/M03_ACLK] [get_bd_pins internalRAM_interconnect/M04_ACLK] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_fpd_aclk]
  connect_bd_net -net clocktreeMTS_UserSYSREF [get_bd_pins clocktreeMTS/UserSYSREF] [get_bd_pins usp_rf_data_converter_1/user_sysref_dac] [get_bd_pins usp_rf_data_converter_1/user_sysref_adc]
  ...
  connect_bd_net -net deepCapture_peripheral_aresetn [get_bd_pins deepCapture/peripheral_aresetn] [get_bd_pins ddr4_0/c0_ddr4_aresetn] [get_bd_pins smartconnect_0/aresetn]
  connect_bd_net -net proc_sys_reset_0_peripheral_aresetn [get_bd_pins clocktreeMTS/s_axi_aresetn] [get_bd_pins deepCapture/axi_resetn] [get_bd_pins gpio_control/s_axi_aresetn] [get_bd_pins control_interconnect/ARESETN] [get_bd_pins control_interconnect/S00_ARESETN] [get_bd_pins control_interconnect/M00_ARESETN] [get_bd_pins control_interconnect/M01_ARESETN] [get_bd_pins control_interconnect/M02_ARESETN] [get_bd_pins control_interconnect/M03_ARESETN] [get_bd_pins control_interconnect/M04_ARESETN] [get_bd_pins control_interconnect/M05_ARESETN] [get_bd_pins control_interconnect/M06_ARESETN] [get_bd_pins usp_rf_data_converter_1/s_axi_aresetn]
  ...
  connect_bd_net -net zynq_ultra_ps_e_0_pl_clk0 [get_bd_pins zynq_ultra_ps_e_0/pl_clk0] [get_bd_pins clocktreeMTS/s_axi_aclk] [get_bd_pins deepCapture/s_axi_lite_aclk] [get_bd_pins gpio_control/s_axi_aclk] [get_bd_pins control_interconnect/ACLK] [get_bd_pins control_interconnect/S00_ACLK] [get_bd_pins control_interconnect/M00_ACLK] [get_bd_pins control_interconnect/M01_ACLK] [get_bd_pins control_interconnect/M02_ACLK] [get_bd_pins control_interconnect/M03_ACLK] [get_bd_pins control_interconnect/M04_ACLK] [get_bd_pins control_interconnect/M05_ACLK] [get_bd_pins control_interconnect/M06_ACLK] [get_bd_pins usp_rf_data_converter_1/s_axi_aclk] [get_bd_pins zynq_ultra_ps_e_0/maxihpm0_lpd_aclk]
  connect_bd_net -net zynq_ultra_ps_e_0_pl_resetn0 [get_bd_pins zynq_ultra_ps_e_0/pl_resetn0] [get_bd_pins clocktreeMTS/ext_reset_in]
  ...
  regenerate_bd_layout -layout_string {
   ...
   "Interfaces View_Layers":"/clocktreeMTS/clk_wiz_adc0_clk_out2:false|/deepCapture/rst_ddr4_0_333M_peripheral_aresetn:false|/clocktreeMTS/clk_wiz_0_clk_out1:false|/clocktreeMTS/proc_sys_reset_0_peripheral_aresetn:false|/ddr4_0_c0_ddr4_ui_clk:false|/clocktreeMTS/RFegressReset_peripheral_aresetn:false|/usp_rf_data_converter_1_irq:false|/zynq_ultra_ps_e_0_pl_clk0:false|/clocktreeMTS/IBUFDS_SYSREF_IBUF_OUT:false|/zynq_ultra_ps_e_0_pl_resetn0:false|/deepCapture/axi_dma_adc_s2mm_introut:false|/clocktreeMTS/IBUFDS_PL_CLK_IBUF_OUT:false|/clocktreeMTS/RFingressReset_peripheral_aresetn:false|/clocktreeMTS/util_ds_buf_0_BUFG_O:false|/clocktreeMTS/MTSclkwiz_interrupt:false|/ddr4_0_c0_ddr4_ui_clk_sync_rst:false|/reset_1:false|",
   "Interfaces View_ScaleFactor":"0.505296",
   "Interfaces View_TopLeft":"-226,-354",
   "Reduced Jogs_Layers":"/clocktreeMTS/clk_wiz_adc0_clk_out2:true|/deepCapture/rst_ddr4_0_333M_peripheral_aresetn:true|/clocktreeMTS/clk_wiz_0_clk_out1:true|/clocktreeMTS/proc_sys_reset_0_peripheral_aresetn:true|/ddr4_0_c0_ddr4_ui_clk:true|/clocktreeMTS/RFegressReset_peripheral_aresetn:true|/usp_rf_data_converter_1_irq:true|/zynq_ultra_ps_e_0_pl_clk0:true|/clocktreeMTS/IBUFDS_SYSREF_IBUF_OUT:true|/zynq_ultra_ps_e_0_pl_resetn0:true|/deepCapture/axi_dma_adc_s2mm_introut:true|/clocktreeMTS/IBUFDS_PL_CLK_IBUF_OUT:true|/clocktreeMTS/RFingressReset_peripheral_aresetn:true|/clocktreeMTS/util_ds_buf_0_BUFG_O:true|/clocktreeMTS/MTSclkwiz_interrupt:true|/ddr4_0_c0_ddr4_ui_clk_sync_rst:true|/reset_1:true|",
   "Reduced Jogs_ScaleFactor":"0.36614",
...
import_files -fileset constrs_1 -norecurse ./xdc/mts.xdc
